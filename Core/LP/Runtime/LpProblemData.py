...
class LpProblemData:
    ...
    def __eq__(self, other):
        ...
        eq_objv = self.equal_objv(lhs_objv['coefficients'], rhs_objv['coefficients'])
        eq_objv &= lhs_objv['goal'] == rhs_objv['goal']

        lhs_consrts = self.data['constraints']
        rhs_consrts = other.data['constraints']
        eq_consrts = self.equal_consrts(lhs_consrts['coefficients'], rhs_consrts['coefficients'], lhs_consrts['signs'],
                                        rhs_consrts['signs'])

        lhs_var_consrts = self.data['vars_constraints']
        rhs_var_consrts = other.data['vars_constraints']
        eq_var_consrts = self.equal_consrts(lhs_var_consrts['coefficients'], rhs_var_consrts['coefficients'],
